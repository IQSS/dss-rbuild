...
![*RStudio Webpage*](./mages/rstudio.PNG)
...
![The RStudio Interface](./mages/rstudio2.PNG)
...
![](mages/PackageSS/createproj1.PNG)

Then click "R Package" when you see the screen below:

![](mages/PackageSS/createproj2.PNG)
...
![](mages/PackageSS/createproj3.PNG)
...
![](mages/PackageSS/projectinit.PNG)
