...
The previous page in the guide discussed [RStudio](./rstudioguide.Rmd). The next page in the guide discusses [Package Structure in R](./packagedev.Rmd). This page is an introduction to Git and GitHub for beginners. In it, we'll motivate Git/GitHub, and then discuss what precisely Git/GitHub do and how to use them.
