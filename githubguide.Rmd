...
It's best practice to create new R code files in your local project repository. When you save your code files, initially they will not be under version control, but we can change this by *commiting* them to the local repository using the command: `git commit`. You can add a message to indicate the changes you've made by typing `commit -am` followed by your message in quotes. Once you've committed files, all of the files you've previously added will be saved on your local repository. 
