...
14. **Suggests**: Sometimes, your package will not really *require* the use of other packages, but it might offer a couple of extra wrappers/functions with those other packages. When those extra functions aren't strictly necessary, it's a good idea to have your package *suggest* imports. For example, if Carlos modified the scalep function to look like the following code, he might put ggplot2 in the 'suggests' part of the description. 
