...
### Step 3: Starting to Program

Now, you're ready to start programming! Note that the coding you will do in package development is slightly different than the coding you'll normally do when writing R scripts. This is for a couple reasons:

1. Code is run when it's built, not when it's loaded
2. Try to make your code as general as possible
3. Etc

Go through code style.

1. Comments
2. Names
3. Spacing/parenthesis + curly brackets
4. 

Give examples throughout from the "badexample."

### Step 4: Documenting your package

Creating documentation for your package is incredibly easy with Roxygen2. 

For example, the following code generates the documentation for the "general_sqrt" function written above. 
