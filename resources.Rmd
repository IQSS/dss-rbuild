...
- As always, it's worth referencing stackexchange if you're ever confused. 
<!--
...
- [The official GitHub cheat sheet](https://services.GitHub.com/on-demand/downloads/GitHub-git-cheat-sheet.pdf) lists all of the general commands you'll need
...
- Here are the links to the build congfiguration docs for [Appveyor](https://www.appveyor.com/docs/build-configuration/) and [Travis](https://docs.travis-ci.com/user/languages/r/).
