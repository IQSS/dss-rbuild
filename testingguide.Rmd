...
1. The sets up a "master repo" with a master branch on Github. 
...
3. Each developer makes changes to the project and then pushes those changes to their personal fork. After each push, Appveyor/Travis build the package and test it. 
