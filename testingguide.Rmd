...
1. More description of .yml files?
2. I need to figure out if there are relevant deployment options for CI services. 
...
### 3.2 Setting up Integrated Tests
...
R/* text=lf
```
which forces all the scripts directly in the R subdireectory to use the 'lf' line terminator. You can personalize the gitattributes file if you like, but you can also just use the sample .gitattributes [here](https://github.com/krlmlr/r-appveyor/blob/master/.gitattributes). You can download this file and move it to the root directory of your package (it must be in the root directory). 
